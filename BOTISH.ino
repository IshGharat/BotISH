...
const char* ssid = "BotIsh"; // The name of the WiFi network you want to connect to
const char* password = "Ish@2010"; // The password of the WiFi network

DataParser dataParser; // Create an instance of DataParse

const int udpPort = 2010; // Change this to the desired UDP port
...
void loop() {
  ...
  if(dataParser.getField(0) == "f") // If the first field of the data is "f"
 {
  ...
  Serial.println(dataParser.getField(1));
 }
