...
udp_port = 2010  # Should be the same as the port in the robot program
BUFFER_SIZE = 1024
...
cv2.resizeWindow('Robot Control', 400, 400)
...
def show_live_camera_feed():
    ...
    while True:
        ...
        cv2.putText(cap, text, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 255), 2, cv2.LINE_AA)

        cv2.imshow('Robot Control', cap)  # Display the frame
        ...
        sock.sendto(response_message.encode("utf-8"), ('192.168.4.1', 2010))  # Send the command to the robot
